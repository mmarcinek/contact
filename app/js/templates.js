this["hbs"] = this["hbs"] || {};
this["hbs"]["contacts"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.contacts : depth0),{"name":"each","hash":{},"fn":this.program(1, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "");
},"useData":true});